...
var x__19506__auto__ = (((x == null))?null:x);
var m__19507__auto__ = (sablono.util.to_str[goog.typeOf(x__19506__auto__)]);
if(!((m__19507__auto__ == null))){
return m__19507__auto__.call(null,x);
} else {
var m__19507__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__19507__auto____$1 == null))){
return m__19507__auto____$1.call(null,x);
} else {
...
var x__19506__auto__ = (((x == null))?null:x);
var m__19507__auto__ = (sablono.util.to_uri[goog.typeOf(x__19506__auto__)]);
if(!((m__19507__auto__ == null))){
return m__19507__auto__.call(null,x);
} else {
var m__19507__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__19507__auto____$1 == null))){
return m__19507__auto____$1.call(null,x);
} else {
...
var len__19912__auto___27696 = arguments.length;
var i__19913__auto___27697 = (0);
while(true){
if((i__19913__auto___27697 < len__19912__auto___27696)){
args__19919__auto__.push((arguments[i__19913__auto___27697]));

var G__27698 = (i__19913__auto___27697 + (1));
i__19913__auto___27697 = G__27698;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__19920__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq27695){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq27695));
});
/**
...
var vec__27700 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__27700,(0),null);
var words = cljs.core.nthnext.call(null,vec__27700,(1));
...
var G__27702 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__27702,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__27702;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__27703_SHARP_){
if(typeof p1__27703_SHARP_ === 'string'){
return p1__27703_SHARP_;
} else {
return cljs.core.seq.call(null,p1__27703_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__18843__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1478297186049