...
var len__19942__auto___62212 = arguments.length;
var i__19943__auto___62213 = (0);
while(true){
if((i__19943__auto___62213 < len__19942__auto___62212)){
args__19949__auto__.push((arguments[i__19943__auto___62213]));

var G__62214 = (i__19943__auto___62213 + (1));
i__19943__auto___62213 = G__62214;
continue;
} else {
}
break;
...
ui.views.common.form.attr_form.cljs$core$IFn$_invoke$arity$variadic = (function (p__62206){
var map__62207 = p__62206;
var map__62207__$1 = ((((!((map__62207 == null)))?((((map__62207.cljs$lang$protocol_mask$partition0$ & (64))) || (map__62207.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__62207):map__62207);
var model = cljs.core.get.call(null,map__62207__$1,new cljs.core.Keyword(null,"model","model",331153215));
var on_commit = cljs.core.get.call(null,map__62207__$1,new cljs.core.Keyword(null,"on-commit","on-commit",551275063));
var content_fn = cljs.core.get.call(null,map__62207__$1,new cljs.core.Keyword(null,"content-fn","content-fn",-1280686114));
var form_fn = cljs.core.get.call(null,map__62207__$1,new cljs.core.Keyword(null,"form-fn","form-fn",813273806));
...
var commit_BANG_ = ((function (local_model,edit_QMARK_,map__62207,map__62207__$1,model,on_commit,content_fn,form_fn){
return (function (){
on_commit.call(null,cljs.core.deref.call(null,local_model));

return cljs.core.reset_BANG_.call(null,edit_QMARK_,false);
});})(local_model,edit_QMARK_,map__62207,map__62207__$1,model,on_commit,content_fn,form_fn))
;
var discard_BANG_ = ((function (local_model,edit_QMARK_,commit_BANG_,map__62207,map__62207__$1,model,on_commit,content_fn,form_fn){
return (function (){
cljs.core.reset_BANG_.call(null,local_model,cljs.core.deref.call(null,model));

return cljs.core.reset_BANG_.call(null,edit_QMARK_,false);
});})(local_model,edit_QMARK_,commit_BANG_,map__62207,map__62207__$1,model,on_commit,content_fn,form_fn))
;
var edit_BANG_ = ((function (local_model,edit_QMARK_,commit_BANG_,discard_BANG_,map__62207,map__62207__$1,model,on_commit,content_fn,form_fn){
return (function (){
return cljs.core.reset_BANG_.call(null,edit_QMARK_,true);
});})(local_model,edit_QMARK_,commit_BANG_,discard_BANG_,map__62207,map__62207__$1,model,on_commit,content_fn,form_fn))
;
var watch_id = cljs.core.gensym.call(null);
cljs.core.add_watch.call(null,model,watch_id,((function (local_model,edit_QMARK_,commit_BANG_,discard_BANG_,edit_BANG_,watch_id,map__62207,map__62207__$1,model,on_commit,content_fn,form_fn){
return (function (_,___$1,___$2,v){
return cljs.core.reset_BANG_.call(null,local_model,v);
});})(local_model,edit_QMARK_,commit_BANG_,discard_BANG_,edit_BANG_,watch_id,map__62207,map__62207__$1,model,on_commit,content_fn,form_fn))
);

return ((function (local_model,edit_QMARK_,commit_BANG_,discard_BANG_,edit_BANG_,watch_id,map__62207,map__62207__$1,model,on_commit,content_fn,form_fn){
return (function() { 
var G__62215__delegate = function (p__62209){
var map__62210 = p__62209;
var map__62210__$1 = ((((!((map__62210 == null)))?((((map__62210.cljs$lang$protocol_mask$partition0$ & (64))) || (map__62210.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__62210):map__62210);
var icon = cljs.core.get.call(null,map__62210__$1,new cljs.core.Keyword(null,"icon","icon",1679606541));
var class$ = cljs.core.get.call(null,map__62210__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var overlay_opacity = cljs.core.get.call(null,map__62210__$1,new cljs.core.Keyword(null,"overlay-opacity","overlay-opacity",-1938296818));
...
var G__62215 = function (var_args){
var p__62209 = null;
if (arguments.length > 0) {
var G__62216__i = 0, G__62216__a = new Array(arguments.length -  0);
while (G__62216__i < G__62216__a.length) {G__62216__a[G__62216__i] = arguments[G__62216__i + 0]; ++G__62216__i;}
  p__62209 = new cljs.core.IndexedSeq(G__62216__a,0);
} 
return G__62215__delegate.call(this,p__62209);};
G__62215.cljs$lang$maxFixedArity = 0;
G__62215.cljs$lang$applyTo = (function (arglist__62217){
var p__62209 = cljs.core.seq(arglist__62217);
return G__62215__delegate(p__62209);
});
G__62215.cljs$core$IFn$_invoke$arity$variadic = G__62215__delegate;
return G__62215;
})()
;
;})(local_model,edit_QMARK_,commit_BANG_,discard_BANG_,edit_BANG_,watch_id,map__62207,map__62207__$1,model,on_commit,content_fn,form_fn))
...
ui.views.common.form.attr_form.cljs$lang$applyTo = (function (seq62205){
return ui.views.common.form.attr_form.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq62205));
});

//# sourceMappingURL=form.js.map?rel=1478769133941