...
var len__19942__auto___48474 = arguments.length;
var i__19943__auto___48475 = (0);
while(true){
if((i__19943__auto___48475 < len__19942__auto___48474)){
args__19949__auto__.push((arguments[i__19943__auto___48475]));

var G__48476 = (i__19943__auto___48475 + (1));
i__19943__auto___48475 = G__48476;
continue;
} else {
}
break;
...
ui.views.common.form.attr_form.cljs$core$IFn$_invoke$arity$variadic = (function (p__48468){
...
var model = cljs.core.get.call(null,map__48469__$1,new cljs.core.Keyword(null,"model","model",331153215));
var on_commit = cljs.core.get.call(null,map__48469__$1,new cljs.core.Keyword(null,"on-commit","on-commit",551275063));
var content_fn = cljs.core.get.call(null,map__48469__$1,new cljs.core.Keyword(null,"content-fn","content-fn",-1280686114));
var form_fn = cljs.core.get.call(null,map__48469__$1,new cljs.core.Keyword(null,"form-fn","form-fn",813273806));
...
var commit_BANG_ = ((function (local_model,edit_QMARK_,map__48469,map__48469__$1,model,on_commit,content_fn,form_fn){
return (function (){
on_commit.call(null,cljs.core.deref.call(null,local_model));

return cljs.core.reset_BANG_.call(null,edit_QMARK_,false);
});})(local_model,edit_QMARK_,map__48469,map__48469__$1,model,on_commit,content_fn,form_fn))
;
var discard_BANG_ = ((function (local_model,edit_QMARK_,commit_BANG_,map__48469,map__48469__$1,model,on_commit,content_fn,form_fn){
return (function (){
cljs.core.reset_BANG_.call(null,local_model,cljs.core.deref.call(null,model));

return cljs.core.reset_BANG_.call(null,edit_QMARK_,false);
});})(local_model,edit_QMARK_,commit_BANG_,map__48469,map__48469__$1,model,on_commit,content_fn,form_fn))
;
var edit_BANG_ = ((function (local_model,edit_QMARK_,commit_BANG_,discard_BANG_,map__48469,map__48469__$1,model,on_commit,content_fn,form_fn){
return (function (){
return cljs.core.reset_BANG_.call(null,edit_QMARK_,true);
});})(local_model,edit_QMARK_,commit_BANG_,discard_BANG_,map__48469,map__48469__$1,model,on_commit,content_fn,form_fn))
;
var watch_id = cljs.core.gensym.call(null);
cljs.core.add_watch.call(null,model,watch_id,((function (local_model,edit_QMARK_,commit_BANG_,discard_BANG_,edit_BANG_,watch_id,map__48469,map__48469__$1,model,on_commit,content_fn,form_fn){
return (function (_,___$1,___$2,v){
return cljs.core.reset_BANG_.call(null,local_model,v);
});})(local_model,edit_QMARK_,commit_BANG_,discard_BANG_,edit_BANG_,watch_id,map__48469,map__48469__$1,model,on_commit,content_fn,form_fn))
);

return ((function (local_model,edit_QMARK_,commit_BANG_,discard_BANG_,edit_BANG_,watch_id,map__48469,map__48469__$1,model,on_commit,content_fn,form_fn){
return (function() { 
var G__48477__delegate = function (p__48471){
var map__48472 = p__48471;
var map__48472__$1 = ((((!((map__48472 == null)))?((((map__48472.cljs$lang$protocol_mask$partition0$ & (64))) || (map__48472.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__48472):map__48472);
var icon = cljs.core.get.call(null,map__48472__$1,new cljs.core.Keyword(null,"icon","icon",1679606541));
var class$ = cljs.core.get.call(null,map__48472__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var overlay_opacity = cljs.core.get.call(null,map__48472__$1,new cljs.core.Keyword(null,"overlay-opacity","overlay-opacity",-1938296818));
...
var G__48477 = function (var_args){
var p__48471 = null;
if (arguments.length > 0) {
var G__48478__i = 0, G__48478__a = new Array(arguments.length -  0);
while (G__48478__i < G__48478__a.length) {G__48478__a[G__48478__i] = arguments[G__48478__i + 0]; ++G__48478__i;}
  p__48471 = new cljs.core.IndexedSeq(G__48478__a,0);
} 
return G__48477__delegate.call(this,p__48471);};
G__48477.cljs$lang$maxFixedArity = 0;
G__48477.cljs$lang$applyTo = (function (arglist__48479){
var p__48471 = cljs.core.seq(arglist__48479);
return G__48477__delegate(p__48471);
});
...
ui.views.common.form.attr_form.cljs$lang$applyTo = (function (seq48467){
return ui.views.common.form.attr_form.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq48467));
});

//# sourceMappingURL=form.js.map?rel=1478934890287