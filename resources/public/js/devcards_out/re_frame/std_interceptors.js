...
var vec__22256_22257 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_22258 = cljs.core.nth.call(null,vec__22256_22257,(0),null);
var only_after_22259 = cljs.core.nth.call(null,vec__22256_22257,(1),null);
var db_changed_QMARK__22260 = (cljs.core.some_QMARK_.call(null,only_before_22258)) || (cljs.core.some_QMARK_.call(null,only_after_22259));
if(db_changed_QMARK__22260){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_22258);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_22259);
...
return cljs.core.update_in.call(null,context,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"coeffects","coeffects",497912985),new cljs.core.Keyword(null,"event","event",301435442)], null),cljs.core.subvec,(1));
}));
/**
...
var map__22267 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__22267__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__22267__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__22275 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__22275__$1;
var event = cljs.core.get.call(null,map__22275__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__19912__auto___22278 = arguments.length;
var i__19913__auto___22279 = (0);
while(true){
if((i__19913__auto___22279 < len__19912__auto___22278)){
args__19919__auto__.push((arguments[i__19913__auto___22279]));

var G__22280 = (i__19913__auto___22279 + (1));
i__19913__auto___22279 = G__22280;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__19920__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq22277){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq22277));
});
/**
...
var args__19919__auto__ = [];
var len__19912__auto___22286 = arguments.length;
var i__19913__auto___22287 = (0);
while(true){
if((i__19913__auto___22287 < len__19912__auto___22286)){
args__19919__auto__.push((arguments[i__19913__auto___22287]));

var G__22288 = (i__19913__auto___22287 + (1));
i__19913__auto___22287 = G__22288;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__19920__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__22281_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__22282_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__22282_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq22283){
var G__22284 = cljs.core.first.call(null,seq22283);
var seq22283__$1 = cljs.core.next.call(null,seq22283);
var G__22285 = cljs.core.first.call(null,seq22283__$1);
var seq22283__$2 = cljs.core.next.call(null,seq22283__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__22284,G__22285,seq22283__$2);
});

//# sourceMappingURL=std_interceptors.js.map?rel=1478297176478