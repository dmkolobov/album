...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__27706_SHARP_){
return ((p1__27706_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__27706_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.call(null,G__27708,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__27708;
}
});
...
var len__19912__auto___27711 = arguments.length;
var i__19913__auto___27712 = (0);
while(true){
if((i__19913__auto___27712 < len__19912__auto___27711)){
args__19919__auto__.push((arguments[i__19913__auto___27712]));

var G__27713 = (i__19913__auto___27712 + (1));
i__19913__auto___27712 = G__27713;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__19920__auto__);
});
...
var G__27710 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__27710,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__27710;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq27709){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq27709));
});
/**
...
var vec__27717 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__27717,(0),null);
var names = cljs.core.nth.call(null,vec__27717,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__27717,tag_name,names){
return (function (p1__27714_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__27714_SHARP_));
});})(matches,vec__27717,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__27717,tag_name,names){
return (function (p1__27715_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__27715_SHARP_));
});})(matches,vec__27717,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__27718){
var vec__27721 = p__27718;
var tag = cljs.core.nth.call(null,vec__27721,(0),null);
var content = cljs.core.nthnext.call(null,vec__27721,(1));
...
var vec__27722 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__27722,(0),null);
var id = cljs.core.nth.call(null,vec__27722,(1),null);
var class$ = cljs.core.nth.call(null,vec__27722,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1478297186151