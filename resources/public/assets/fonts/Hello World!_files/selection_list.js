...
var args27504 = [];
var len__19912__auto___27507 = arguments.length;
var i__19913__auto___27508 = (0);
while(true){
if((i__19913__auto___27508 < len__19912__auto___27507)){
args27504.push((arguments[i__19913__auto___27508]));

var G__27509 = (i__19913__auto___27508 + (1));
i__19913__auto___27508 = G__27509;
continue;
} else {
}
break;
...
var base_style__$1 = (cljs.core.truth_((function (){var and__18831__auto__ = selected_QMARK_;
...
var base_style__$2 = (cljs.core.truth_((function (){var and__18831__auto__ = selected_QMARK_;
if(cljs.core.truth_(and__18831__auto__)){
...
if(cljs.core.truth_((function (){var and__18831__auto__ = required_QMARK_;
if(cljs.core.truth_(and__18831__auto__)){
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__27514){
...
var args = map__27517__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__27517__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__27517__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__27517__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__27517__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__27517__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__27517__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__27517__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__27517__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__27517__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__27517__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__27517__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__27517,map__27517__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__27511_SHARP_){
return item_renderer.call(null,p1__27511_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__27517,map__27517__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__27517,map__27517__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__27512_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__27512_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__27517,map__27517__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__27517,map__27517__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__27513_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__27513_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__27517,map__27517__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__19912__auto___27526 = arguments.length;
var i__19913__auto___27527 = (0);
while(true){
if((i__19913__auto___27527 < len__19912__auto___27526)){
args__19919__auto__.push((arguments[i__19913__auto___27527]));

var G__27528 = (i__19913__auto___27527 + (1));
i__19913__auto___27527 = G__27528;
continue;
} else {
}
break;
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__19920__auto__);
});

re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__27520){
...
var args = map__27521__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__27521,map__27521__$1,args){
return (function() { 
var G__27529__delegate = function (p__27523){
...
var G__27529 = function (var_args){
var p__27523 = null;
...
while (G__27530__i < G__27530__a.length) {G__27530__a[G__27530__i] = arguments[G__27530__i + 0]; ++G__27530__i;}
  p__27523 = new cljs.core.IndexedSeq(G__27530__a,0);
} 
return G__27529__delegate.call(this,p__27523);};
G__27529.cljs$lang$maxFixedArity = 0;
G__27529.cljs$lang$applyTo = (function (arglist__27531){
var p__27523 = cljs.core.seq(arglist__27531);
return G__27529__delegate(p__27523);
});
G__27529.cljs$core$IFn$_invoke$arity$variadic = G__27529__delegate;
return G__27529;
})()
;
;})(map__27521,map__27521__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq27519){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq27519));
});

//# sourceMappingURL=selection_list.js.map?rel=1478297185185