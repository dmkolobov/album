...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__19449__auto__,writer__19450__auto__,opt__19451__auto__){
return cljs.core._write.call(null,writer__19450__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__20506 = o;
(G__20506[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__20508__i < G__20508__a.length) {G__20508__a[G__20508__i] = arguments[G__20508__i + 0]; ++G__20508__i;}
  args = new cljs.core.IndexedSeq(G__20508__a,0);
} 
...
if(cljs.core.truth_((function (){var and__18831__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__18831__auto__){
var and__18831__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__18831__auto____$1){
var and__18831__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
...
var G__20514 = jsprops;
(G__20514["defaultValue"] = value);

(G__20514["onChange"] = ((function (G__20514,v,value,on_change){
return (function (p1__20512_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__20512_SHARP_);
});})(G__20514,v,value,on_change))
);
...
var vec__20519 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__20519,(0),null);
var id = cljs.core.nth.call(null,vec__20519,(1),null);
var class$ = cljs.core.nth.call(null,vec__20519,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___20522 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___20522 == null)){
} else {
var key_20523 = temp__4661__auto___20522;
(jsprops["key"] = key_20523);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__20525 = (new reagent.impl.template.NativeWrapper());
(G__20525["name"] = c);
...
var len__19912__auto___20531 = arguments.length;
var i__19913__auto___20532 = (0);
while(true){
if((i__19913__auto___20532 < len__19912__auto___20531)){
args__19919__auto__.push((arguments[i__19913__auto___20532]));

var G__20533 = (i__19913__auto___20532 + (1));
i__19913__auto___20532 = G__20533;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__19920__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq20529){
var G__20530 = cljs.core.first.call(null,seq20529);
var seq20529__$1 = cljs.core.next.call(null,seq20529);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__20530,seq20529__$1);
});
...
break;
default:
var G__20537 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__20537;
continue;
...
var n__19757__auto___20540 = a.length;
var i_20541 = (0);
while(true){
if((i_20541 < n__19757__auto___20540)){
(a[i_20541] = reagent.impl.template.as_element.call(null,(a[i_20541])));
...
var a = cljs.core.into_array.call(null,s);
var n__19757__auto___20543 = a.length;
var i_20544 = (0);
while(true){
if((i_20544 < n__19757__auto___20543)){
var val_20545 = (a[i_20544]);
if((cljs.core.vector_QMARK_.call(null,val_20545)) && ((reagent.impl.template.key_from_vec.call(null,val_20545) == null))){
(o["no-key"] = true);
} else {
}

(a[i_20544] = reagent.impl.template.as_element.call(null,val_20545));

var G__20546 = (i_20544 + (1));
i_20544 = G__20546;
continue;
} else {
}
...
var ctx = {};
var vec__20548 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__20548,(0),null);
var derefed = cljs.core.nth.call(null,vec__20548,(1),null);
...
var G__20550 = (cljs.core.count.call(null,argv) - first_child);
switch (G__20550) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__20550){
...
//# sourceMappingURL=template.js.map?rel=1478297170356